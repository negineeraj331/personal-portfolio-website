...
export const projects: Project[] = [
  {
    id: "infinite-equinox",
    title: "Infinite-Equinox - Online Legal Consultant",
    description: "A platform connecting users with verified legal professionals for online consultations and digital document generation. Simplifies searching for lawyers by need/location, featuring JWT authentication and E2EE (End-to-End Encrypted) conversations.",
    tags: ["Node.js", "Express.js", "React.js", "Tailwind CSS", "MongoDB", "JWT", "E2EE"],
    githubUrl: "https://github.com/negineeraj331/Infinite-Equinox",
    imageColor: "from-blue-600 to-indigo-600",
    imageUrl: "/projects/infinite_equinox.png",
    featured: true,
    size: "large",
  },
  {
    ...
    githubUrl: "https://github.com/negineeraj331/Airport-Route-Planner",
    imageColor: "from-pink-500 to-violet-600",
    imageUrl: "/projects/jeteng.png",
    featured: true,
    size: "large",
  },
  {
    ...
    githubUrl: "https://github.com/negineeraj331/Cooking-Assistant-AI",
    imageColor: "from-violet-500 to-fuchsia-600",
    imageUrl: "/projects/cookingai.png",
    featured: true,
    size: "medium",
  },
  {
    id: "cropmonitor",
    title: "CropMonitor - Smart Farming Dashboard",
    description: "A smart, intuitive solution designed to empower farmers with real-time weather data, smart alerts, and intelligent task management.",
    tags: ["HTML", "Tailwind CSS", "JavaScript", "PHP"],
    githubUrl: "https://github.com/negineeraj331/CropMonitor",
    imageColor: "from-emerald-500 to-teal-600",
    imageUrl: "/projects/cropmonitor.png",
    featured: true,
    size: "medium",
  },
  {
...
export const experiences: Experience[] = [
  ...
  {
    id: "patent-exosuits",
    role: "Patent Filed - AI-Powered Adaptive Exosuits",
    company: "Deep-Sea Exploration & Marine Research",
    duration: "2024 - Present",
    description: [
      "Officially filed a patent for 'AI-Powered Adaptive Exosuits for Deep-Sea Exploration, Tourism, and Marine Research'",
      "Demonstrated advanced innovation and technical problem-solving in deep-tech domains"
    ],
    type: "work",
  },
  {
    ...
    type: "training",
    certificatePath: "/certificates/codequest-dsa.png",
    certificateImage: "/certificates/codequest-dsa.png",
  },
  {
    id: "edu-intermediate",
